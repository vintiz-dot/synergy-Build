  ...
  */ !function(t, e) {
    ...
    const j = {
        ...
        off (t, e, i, n) {
            ...
            c && Object.keys(l).forEach((i)=>{
                !function(t, e, i, n) {
                    ...
                    Object.keys(s).forEach((o)=>{
                        if (o.includes(n)) {
                            const n1 = s[o];
                            I(t, e, i, n1.originalHandler, n1.delegationSelector);
                        }
                    });
                }(t, l, i, e.slice(1));
            });
            ...
            Object.keys(h).forEach((i)=>{
                ...
                if (!a || e.includes(n)) {
                    const e1 = h[i];
                    I(t, l, r, e1.originalHandler, e1.delegationSelector);
                }
            });
        },
        trigger (t, e, i) {
    ...
    class pt extends B {
        constructor(t, e){
            ...
            const n = V.find(ft);
            for(let t1 = 0, e1 = n.length; t1 < e1; t1++){
                const e2 = n[t1], s = i(e2), o = V.find(s).filter((t)=>t === this._element);
                null !== s && o.length && (this._selector = s, this._triggerArray.push(e2));
            }
        ...
        show() {
            ...
            if (this._config.parent) {
                const t1 = V.find(ut, this._config.parent);
                e = V.find(".collapse.show, .collapse.collapsing", this._config.parent).filter((e)=>!t1.includes(e));
            }
            ...
            this._queueCallback(()=>{
                this._isTransitioning = !1, this._element.classList.remove(ht), this._element.classList.add(ct, lt), this._element.style[n1] = "", j.trigger(this._element, "shown.bs.collapse");
        ...
        hide() {
            ...
            for(let t1 = 0; t1 < e; t1++){
                const e1 = this._triggerArray[t1], i = n(e1);
    ...
    function de(t) {
        ...
        if (c) {
            ...
            w === Wt(i) && "static" !== Yt(w = Gt(i)).position && "absolute" === a && (E = "scrollHeight", A = "scrollWidth"), w, s !== mt && (s !== bt && s !== _t || o !== Et) || (v = gt, m -= w[E] - n.height, m *= l ? 1 : -1), s !== bt && (s !== mt && s !== gt || o !== Et) || (b = _t, f -= w[A] - n.width, f *= l ? 1 : -1);
        }
    ...
    class hi extends B {
        ...
        static clearMenus(t) {
            ...
            for(let i = 0, n = e.length; i < n; i++){
                ...
                if (t) {
                    const e1 = t.composedPath(), i1 = e1.includes(n1._menu);
    ...
    function Yi(t, e, i) {
        ...
        for(let t1 = 0, i1 = s.length; t1 < i1; t1++){
            const i2 = s[t1], n1 = i2.nodeName.toLowerCase();
            if (!Object.keys(e).includes(n1)) {
                i2.remove();
                continue;
            }
            const o = [].concat(...i2.attributes), r = [].concat(e["*"] || [], e[n1] || []);
            o.forEach((t)=>{
                Xi(t, r) || i2.removeAttribute(t.nodeName);
            });
        }
    ...
    class xn extends B {
        ...
        show() {
            ...
            if (i) {
                const e1 = "UL" === i.nodeName || "OL" === i.nodeName ? Ln : kn;
        ...
        _transitionComplete(t, e, i) {
            if (e) {
                ...
                const t1 = V.findOne(":scope > .dropdown-menu .active", e.parentNode);
                t1 && t1.classList.remove(Tn), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !1);
            }
            t.classList.add(Tn), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), u(t), t.classList.contains(On) && t.classList.add(Cn);
            let n = t.parentNode;
            if (n && "LI" === n.nodeName && (n = n.parentNode), n && n.classList.contains("dropdown-menu")) {
                const e1 = t.closest(".dropdown");
                e1 && V.find(".dropdown-toggle", e1).forEach((t)=>t.classList.add(Tn)), t.setAttribute("aria-expanded", !0);
            }
            i && i();
        }
        static jQueryInterface(t) {
...
//# sourceMappingURL=index.6927dae7.js.map
