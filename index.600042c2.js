        ...
        return a = n, i = [
            ...
            },
            {
                ...
                value: function(e) {
                    var t = this;
                    e.forEach(function(e) {
                        !0 === t.parseConfig(e).legacy && t.elementIsInView(e) && t.animateElements([
                            e
                        ]);
                    });
                }
            ...
            },
            {
                ...
                value: function(r) {
                    ...
                    return i.forEach(function(e) {
                        var t = e.name.replace("data-purecounter-", "").toLowerCase(), r = "duration" == t ? parseInt(1e3 * n.parseValue(e.value)) : n.parseValue(e.value);
                        o[t] = r;
                    }), Object.assign(a, o);
                }
            },
...
//# sourceMappingURL=index.600042c2.js.map
